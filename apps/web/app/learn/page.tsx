    ...
    <div className="container px-4 md:px-6 py-8">
      <div className="space-y-8">
        ...
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-bold">Aprende a Usar Prompts</h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Domina el arte de crear prompts efectivos y aprovecha al máximo las capacidades de la IA.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {resources.map(resource => (
              <Card key={resource.href} className="relative group hover:shadow-lg transition-all">
                <Link href={resource.href} className="absolute inset-0" />
                <CardHeader>
                  <div className="flex items-center gap-4">
                    <div className="p-2 rounded-lg bg-primary/10 text-primary">
